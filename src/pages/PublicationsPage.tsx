        ...
        <div className="mt-6 sm:mt-8 relative rounded-xl sm:rounded-2xl overflow-hidden">
          ...
          <div className="relative p-6 sm:p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 text-center sm:text-left">
              ...
              <div>
                <h3 className="font-heading text-lg sm:text-xl text-primary-foreground mb-1">View Complete Publication List</h3>
    ...
    >
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-heading text-sm sm:text-lg font-medium text-foreground mb-1.5 sm:mb-2 leading-snug group-hover:text-accent transition-colors">
            {publication.title}
          </h3>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              {citations > 0 && (
                <span className="inline-flex items-center gap-1 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-accent/15 text-accent text-[10px] sm:text-xs font-medium">
