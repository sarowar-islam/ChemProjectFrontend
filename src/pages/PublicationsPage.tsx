...
function PublicationCard({
  ...
  return (
    <div
      className="group bg-card rounded-lg sm:rounded-xl border border-border p-4 sm:p-6 hover:shadow-elevated transition-all duration-300 animate-fade-in-up"
      style={{ animationDelay: delay }}
    >
      <div className="flex items-start gap-3 sm:gap-4">
        <div className="p-2 sm:p-3 rounded-lg sm:rounded-xl bg-accent/10 text-accent shrink-0 group-hover:bg-accent group-hover:text-white transition-colors">
          <FileText className="w-4 h-4 sm:w-5 sm:h-5" />
        </div>
        <div className="flex-1 min-w-0">
          <h3 className="font-heading text-sm sm:text-lg font-medium text-foreground mb-1.5 sm:mb-2 leading-snug group-hover:text-primary transition-colors">
            {publication.title}
          </h3>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              {citations > 0 && (
                <span className="inline-flex items-center gap-1 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-amber-100 text-amber-700 text-[10px] sm:text-xs font-medium">
              ...
              {publication.articleUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 sm:gap-1.5 text-xs sm:text-sm text-primary hover:text-accent font-medium transition-colors"
                >
                  View
