    ...
    <footer className="bg-[#0F172A] text-[#E5E7EB]">
      <div className="container-wide section-padding">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading text-lg mb-4 text-[#E5E7EB]">Quick Links</h4>
            <nav className="flex flex-col gap-2">
              {[
                ...
                <Link
                  key={link.path}
                  to={link.path}
                  className="text-[#94A3B8] hover:text-accent text-sm transition-colors"
                >
                  {link.label}
                </Link>
              ))}
              <Link
                to="/teamlogin"
                className="inline-flex items-center gap-2 text-[#94A3B8] hover:text-accent text-sm transition-colors mt-2 pt-2 border-t border-[#94A3B8]/15"
              >
          ...
          {/* Contact */}
          <div>
            <h4 className="font-heading text-lg mb-4 text-[#E5E7EB]">Contact</h4>
        ...
        {/* Bottom */}
        <div className="mt-12 pt-8 border-t border-[#94A3B8]/15">
          {/* Social Media Links */}
          <div className="flex justify-center gap-6 mb-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full bg-[#1E293B] hover:bg-accent/20 text-[#94A3B8] hover:text-accent transition-all"
              aria-label="Facebook"
            >
          ...
          <p className="text-center text-sm text-[#94A3B8]/70">
