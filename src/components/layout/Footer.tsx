        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link
                to="/teamlogin"
                className="inline-flex items-center gap-2 text-primary-foreground/70 hover:text-primary-foreground text-sm transition-colors mt-2 pt-2 border-t border-primary-foreground/10"
              >
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10">
          ...
          <div className="flex justify-center gap-6 mb-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full bg-primary-foreground/10 hover:bg-primary-foreground/20 text-primary-foreground/70 hover:text-primary-foreground transition-all"
              aria-label="Facebook"
            >
          ...
          <p className="text-center text-sm text-primary-foreground/50">
            © {new Date().getFullYear()} Prof. Dr. Yunus Ahmed Research Group. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
